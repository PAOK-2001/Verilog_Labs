...
HD_PWD='D:/ProySisEmb/P15_Gumnut_CPU/P15_Gumnut_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gumnut_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gumnut_system.tcl
